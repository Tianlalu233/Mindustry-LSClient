...
public class Drill extends Block{
    ...
    public void setBars(){
        ...
        bars.add("progress", (DrillBuild e) ->
             new Bar(() -> Core.bundle.format("bar.progress", returnItem == null ? 0 : Math.round(e.progress / (drillTime + hardnessDrillMultiplier * returnItem.hardness) * 100)), () -> Pal.ammo, () -> returnItem == null ? 0 : e.progress / (drillTime + hardnessDrillMultiplier * returnItem.hardness)));
    }
    ...
    public class DrillBuild extends Building{
        ...
        public void updateTile(){
            ...
            if(items.total() < itemCapacity && dominantItems > 0 && efficiency > 0){
                ...
                if(Core.settings.getInt("blockrenderlevel") > BlockRenderLevel.SHADOW.ordinal() && Mathf.chanceDelta(updateEffectChance * warmup))
            ...
            if(dominantItems > 0 && progress >= delay && items.total() < itemCapacity){
                ...
                if (Core.settings.getInt("blockrenderlevel") > BlockRenderLevel.SHADOW.ordinal() && wasVisible) drillEffect.at(x + Mathf.range(drillEffectRnd), y + Mathf.range(drillEffectRnd), dominantItem.color);
            }
        }
