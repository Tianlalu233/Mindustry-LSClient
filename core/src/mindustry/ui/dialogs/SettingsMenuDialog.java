...
public class SettingsMenuDialog extends BaseDialog{
    ...
    void rebuildMenu(){
        ...
        menu.button("@settings.advance", Icon.star, style, isize, () -> visible(2)).marginLeft(marg).row();
        menu.button("@settings.sound", Icon.filters, style, isize, () -> visible(3)).marginLeft(marg).row();
...
game.checkPref("commandmodehold", true);
        ...
        advance.checkPref("hideinvalidturret", false);
...
//        advance.checkPref("showenemyconfig", false); // TODO
    ...
    private void visible(int index){
        ...
        tables.addAll(game, graphics, advance, sound);
